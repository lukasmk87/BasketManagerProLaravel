...
const { formatPrice, getPriceLabel, getSmallBusinessNotice, getAdminPriceLabel, inputPriceToNet, netPriceToInput, adminInputIsGross } = usePricing();
...
const form = useForm({
    ...
    price: netPriceToInput(props.plan.price || 0),
...
const updatePlan = () => {
    ...
    formData.put(route('admin.club-plans.update', props.plan.id));
};
</script>
