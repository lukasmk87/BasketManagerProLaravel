...
<template>
    <AdminLayout title="Voucher bearbeiten">
        <template #header>
            <div class="flex items-center">
                <Link :href="route('admin.vouchers.show', voucher.id)" class="text-gray-500 hover:text-gray-700 mr-2">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form @submit.prevent="submit" class="p-6 space-y-6">
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-4 border-t">
                            <Link :href="route('admin.vouchers.show', voucher.id)">
