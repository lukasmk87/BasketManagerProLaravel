...
const form = useForm({
    ...
    contract_start: props.player?.contract_start ?? '',
    contract_end: props.player?.contract_end ?? '',
    registration_number: props.player?.registration_number ?? '',
    
    // Physical Information
    height_cm: props.player?.height_cm ?? props.player?.height ?? null,
    weight_kg: props.player?.weight_kg ?? props.player?.weight ?? null,
    dominant_hand: props.player?.dominant_hand ?? 'right',
    ...
    last_medical_check: props.player?.last_medical_check ?? '',

    // Insurance Information
    insurance_provider: props.player?.insurance_provider ?? '',
    insurance_policy_number: props.player?.insurance_policy_number ?? '',
    insurance_expires: props.player?.insurance_expires ?? '',
    ...
    academic_eligibility: props.player?.academic_eligibility ?? true,
    ...
    allow_photos: props.player?.allow_photos ?? true,
