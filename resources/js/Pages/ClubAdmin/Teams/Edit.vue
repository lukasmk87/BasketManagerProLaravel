...
const form = useForm({
    ...
    head_coach_id: props.team.head_coach_id || null,
    is_active: props.team.is_active,
});

const submit = () => {
    form.put(route('club-admin.teams.update', props.team.id), {
        onSuccess: () => {
...
<template>
    <ClubAdminLayout title="Team bearbeiten">
        <template #header>
