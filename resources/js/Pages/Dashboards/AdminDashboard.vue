                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <Link :href="route('web.clubs.create')" 
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900">Neuer Club</p>
                                <p class="text-xs text-gray-500">Club erstellen</p>
                            </div>
                        </div>
                    </Link>
                    ...
                    <Link :href="route('web.teams.create')" 
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900">Neues Team</p>
                                <p class="text-xs text-gray-500">Team erstellen</p>
                            </div>
                        </div>
                    </Link>
                    ...
                    <Link :href="route('web.players.create')" 
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900">Neuer Spieler</p>
                                <p class="text-xs text-gray-500">Spieler erstellen</p>
                            </div>
                        </div>
                    </Link>
                    ...
                    <Link :href="route('admin.settings')" 
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Einstellungen</p>
                            </div>
                        </div>
                    </Link>
                </div>
