...
class StoreTeamRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'assistant_coach_id' => ['nullable', 'exists:users,id', 'different:head_coach_id'],
            'is_active' => ['boolean'],
    ...
    public function messages(): array
    {
        return [
            ...
            'assistant_coach_id.exists' => 'Der ausgewählte Co-Trainer existiert nicht.',
            'assistant_coach_id.different' => 'Der Co-Trainer muss sich vom Cheftrainer unterscheiden.',
