...
class UpdatePlayerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $teamId = $this->input('team_id', $player?->team_id);
        ...
        return [
            ...
            'jersey_number' => [
                ...
                'min:0', 
                'max:99',
                $teamId ? Rule::unique('players', 'jersey_number')
            ...
            'is_starter' => ['boolean'],
            'is_captain' => ['boolean'],
            'status' => ['sometimes', Rule::in(['active', 'inactive', 'injured', 'suspended', 'transferred'])],
            ...
            // Statistics update fields
            'games_played' => ['sometimes', 'integer', 'min:0'],
            'games_started' => ['sometimes', 'integer', 'min:0'],
            'minutes_played' => ['sometimes', 'integer', 'min:0'],
            'points_scored' => ['sometimes', 'integer', 'min:0'],
            'field_goals_made' => ['sometimes', 'integer', 'min:0'],
            'field_goals_attempted' => ['sometimes', 'integer', 'min:0'],
            'three_pointers_made' => ['sometimes', 'integer', 'min:0'],
            'three_pointers_attempted' => ['sometimes', 'integer', 'min:0'],
            'free_throws_made' => ['sometimes', 'integer', 'min:0'],
            'free_throws_attempted' => ['sometimes', 'integer', 'min:0'],
            'rebounds_offensive' => ['sometimes', 'integer', 'min:0'],
            'rebounds_defensive' => ['sometimes', 'integer', 'min:0'],
            'assists' => ['sometimes', 'integer', 'min:0'],
            'steals' => ['sometimes', 'integer', 'min:0'],
            'blocks' => ['sometimes', 'integer', 'min:0'],
            'turnovers' => ['sometimes', 'integer', 'min:0'],
            'fouls_personal' => ['sometimes', 'integer', 'min:0'],
            'fouls_technical' => ['sometimes', 'integer', 'min:0'],
    ...
    public function messages(): array
    {
        return [
            ...
            'games_played.min' => 'Die Anzahl gespielter Spiele muss mindestens 0 sein.',
            'points_scored.min' => 'Die Anzahl der Punkte muss mindestens 0 sein.',
    ...
    public function attributes(): array
    {
        return [
            ...
            'games_started' => 'Spiele als Starter',
            'minutes_played' => 'Gespielte Minuten',
            'points_scored' => 'Erzielte Punkte',
            'field_goals_made' => 'Feldtore getroffen',
            'field_goals_attempted' => 'Feldtore versucht',
            'three_pointers_made' => 'Dreier getroffen',
            'three_pointers_attempted' => 'Dreier versucht',
            ...
            'fouls_personal' => 'Persönliche Fouls',
            'fouls_technical' => 'Technische Fouls',
