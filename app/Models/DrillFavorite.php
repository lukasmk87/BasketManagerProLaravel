...
class DrillFavorite extends Model
{
    use HasFactory;
    ...
    {
        return Attribute::make(
            get: fn() => $this->category_override ?? $this->drill->category,
        );
    }
    ...
    public function isAgeGroupSpecific(): Attribute
    {
        return Attribute::make(
            get: fn() => $this->favorite_type === 'age_group' && !is_null($this->intended_age_group),
        );
    }
    ...
    public function getFavoriteContext(): array
    {
        return [
            ...
            'team' => $this->team?->name,
            'age_group' => $this->intended_age_group,
    ...
    {
        // Check if this favorite is applicable for given criteria
        ...
        if (isset($criteria['age_group']) && $this->is_age_group_specific) {
            if ($this->intended_age_group !== $criteria['age_group']) {
                return false;
            }
        }
        ...
        return self::where('user_id', $this->user_id)
                  ...
                  ->where(function ($query) {
                      ...
                      $query->where('favorite_type', $this->favorite_type)
                            ...
                            // Or same age group
                            ->orWhere('intended_age_group', $this->intended_age_group);
                  })
                  ->with('drill')
