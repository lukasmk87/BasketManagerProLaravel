...
class ClubService
{
    ...
    // ============================
    // CLUB SUBSCRIPTION PLAN METHODS
    // ============================

    /**
     * Create a new club subscription plan for a tenant.
     */
    public function createClubPlan(\App\Models\Tenant $tenant, array $data): \App\Models\ClubSubscriptionPlan
    {
        // Validate against tenant capabilities
        $errors = \App\Models\ClubSubscriptionPlan::validateAgainstTenant($data, $tenant);
        ...
        $plan = \App\Models\ClubSubscriptionPlan::create(array_merge($data, [
            'tenant_id' => $tenant->id,
        ]));
     ...
     */
    public function updateClubPlan(\App\Models\ClubSubscriptionPlan $plan, array $data): \App\Models\ClubSubscriptionPlan
    {
        // Validate against tenant capabilities
        $errors = \App\Models\ClubSubscriptionPlan::validateAgainstTenant($data, $plan->tenant);
     ...
     */
    public function assignPlanToClub(Club $club, \App\Models\ClubSubscriptionPlan $plan): void
    {
     ...
     */
    public function getClubsWithoutPlan(\App\Models\Tenant $tenant)
    {
