    ...
    */
    'default_plans' => [
        ...
        [
            ...
            'sort_order' => 2,
            'stripe_product_id' => env('STRIPE_STANDARD_CLUB_PRODUCT_ID'),
            'stripe_price_id_monthly' => env('STRIPE_STANDARD_CLUB_PRICE_MONTHLY'),
            'stripe_price_id_yearly' => env('STRIPE_STANDARD_CLUB_PRICE_YEARLY'),
            'trial_period_days' => 7,
        ],
        [
            'name' => 'Premium Club',
            ...
            'sort_order' => 3,
            'stripe_product_id' => env('STRIPE_PREMIUM_CLUB_PRODUCT_ID'),
            'stripe_price_id_monthly' => env('STRIPE_PREMIUM_CLUB_PRICE_MONTHLY'),
            'stripe_price_id_yearly' => env('STRIPE_PREMIUM_CLUB_PRICE_YEARLY'),
            'trial_period_days' => 14,
        ],
        [
            'name' => 'Enterprise Club',
            'slug' => 'enterprise-club',
            ...
            'sort_order' => 4,
            'stripe_product_id' => env('STRIPE_ENTERPRISE_CLUB_PRODUCT_ID'),
            'stripe_price_id_monthly' => env('STRIPE_ENTERPRISE_CLUB_PRICE_MONTHLY'),
            'stripe_price_id_yearly' => env('STRIPE_ENTERPRISE_CLUB_PRICE_YEARLY'),
